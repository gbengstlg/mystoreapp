...
import 'package:mystoreapp/models/orders_attr.dart';
...
class OrdersFull extends StatefulWidget {
  @override
  _OrdersFullState createState() => _OrdersFullState();
}

class _OrdersFullState extends State<OrdersFull> {
  ...
  Widget build(BuildContext context) {
    ...
    //final cartProvider = Provider.of<CartAttr>(context);
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              globalMethods.showDialogg(
                                  'Remove item!', 'Order will be deleted!',
                                  () async {
                                setState(() {
                                  _isLoading = true;
                                });
